...
const categoryControllers = __importStar(require("../controllers/category.controller"));
...
categoryRouter.delete("/delete/:id/:panelId", categoryControllers.deleteCategoryController);
