...
const DeleteCategory = ({ categoryId, onSuccess }: DeleteCategoryProps) => {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await deleteCategory(categoryId, panelUserId);
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            category with all of it&apos;s children subcategories and products
            from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
