import ApproveDealer from "@/_components/Customer/ApproveDealer";
import DeleteCustomer from "@/_components/Customer/DeleteCustomer";
import { fetchAllNonApprovedOwners } from "@/api/customer-api";
...
const NonApprovedOwner = () => {
  ...
  const getAllNonApprovedOwners = async () => {
    setLoading(true);
    try {
      const res = await fetchAllNonApprovedOwners();
      ...
      <div className="flex justify-between items-center w-full lg:mb-0 mb-6 ">
        <div className="flex justify-start items-center lg:gap-x-2 border pr-3 py-2 shadow rounded">
          <input
            ...
            placeholder="Search all non approved dealers..."
            value={searchQuery}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-40 font-work" align="end">
                      ...
                      <DropdownMenuGroup className="mt-2">
                        <ApproveDealer
                          email={owner.email}
                          onSuccess={getAllNonApprovedOwners}
                        />
                        <DropdownMenuItem>
...
export default NonApprovedOwner;
